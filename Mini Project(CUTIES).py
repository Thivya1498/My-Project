...
lbl = Label(root, text= "Dengan menggunakan aplikasi ini, anda akan membantu\n KKM untuk mengesan kontak pelajar UniMAP yang berada\n dekat dengan pesakit COVID-19 ataupun suspek COVID-19.", fg="black",font=("Courier",12))
...
btn = Button(root, text="Let's Get Started",bg="black",fg="white",font=("starline",14))
